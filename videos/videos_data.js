...
danceVideos = danceVideos.concat([
  ...
  },
  {
    ...
    'url' : 'http://www.youtube.com/watch?v=156NISHQSwQ'
  },
  {
    ...
    'url' : 'http://www.youtube.com/watch?v=IB5HKa60Ys8'
  },
  {
  ...
  },
  {
    ...
    'description' : 'Some basic bronze figures. TaiWan. Routine: <ul> ' +
      ...
      '</ul>',
    'labels' : ['ShoulderToShoulder', 'ChaCha'],
    'url' : 'http://www.youtube.com/watch?v=RMjgnIMCu5A'
  }
]);
...
danceVideos = danceVideos.concat([
  {
    ...
    'description' : 'Bronze Routine: <br>' +
      '<ol>' +
      '<li>  Natural Spin Turn (starting short wall, at corner)' +
      '<li>  Reverse Turn 4-6 ' +
